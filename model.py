...
def Weight_Loss(age, weight, height, fun):
    ...
    data=pd.read_csv("D:/6th semester/mini project/AI_Dietician (1)/AI_Dietician/input.csv")
    ...
    datafin=pd.read_csv("D:/6th semester/mini project/AI_Dietician (1)/AI_Dietician/inputfin.csv")
    ...
    for ii in range(len(y_pred)):
        if y_pred[ii]==2:
            food_items.append(Food_itemsdata[ii])
...
def Weight_Gain(age, weight, height, fun):
...
def Healthy(age, weight, height, fun):
    import pandas as pd
    import numpy as np
